    ...
    <section className="relative bg-black py-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white bg-gradient-to-r from-white via-gray-200 to-gray-400 text-transparent bg-clip-text">
            Our Journey
          </h2>
        ...
        <div className="relative">
          ...
          {timelineData.map((item, index) => (
            <motion.div
              ...
              className={`flex items-center mb-8 ${index % 2 === 0 ? 'justify-start' : 'justify-end'} -mt-32`}
            >
              <div className={`relative w-5/12 ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}>
                <motion.div
                ...
                <div className={`absolute ${index % 2 === 0 ? '-right-2' : '-left-8'} 
